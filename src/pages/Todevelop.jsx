    ...
    >
      <motion.div animate={controls} initial={{ y: 0 }}>
        {items.map((text, idx) => (
          <div
            key={idx}
            className="rounded-sm font-anton text-center text-[20px]  md:text-[35px]  flex bg-main items-center justify-center tracking-wider px-4"
            style={{
  ...
  return (
    <>
      <div className="section md:mb-18  bg-black relative">
        ...
        <div className="w-[80%]">
          <div className="text">
            <h2 className="text-white text-[25px] md:text-[32px] md:text-center mb-4 font-nycd">
              <HandwrittenEffect
                text={"We work with creators, brands, and international studios to develop"}
                delay={0.2}
              />
            </h2>
          </div>
          ...
          <h2 className="text-white text-[25px] md:text-center mt-5 font-nycd">
            <HandwrittenEffect
              delay={1.6}
              text={
                "always ensuring control over lighting, angles, continuity, atmosphere and visual storytelling"
              }
            />
          </h2>
        </div>
